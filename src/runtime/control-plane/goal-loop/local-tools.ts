...
const TOOL_META: Record<string, {
  ...
  codex_cli: {
    ...
    command: 'codex',
    capabilityTags: ['code_patch', 'code_review', 'tool_calling', 'local_file_mutation'],
  ...
  claude_cli: {
    ...
    command: 'claude',
    capabilityTags: ['code_patch', 'code_review', 'long_context', 'local_file_mutation'],
  ...
  grok_cli: {
    ...
    command: 'grok',
    capabilityTags: ['code_patch', 'code_review', 'tool_calling', 'long_context', 'local_file_mutation'],
